...
const DestinationCity = ({setDestinationCityCode}) => {
  const errRef = useRef();
  ...
  <Fragment>
    ...
    <Typography mb={1.3} variant="body2" gutterBottom>Destination City: </Typography>
     {/* <pre>{JSON.stringify(options)}</pre>
      ...
      <Autocomplete
            ...
            onChange={(event, newValue) => {
              ...
              setDestinationCityCode(newValue?.code);
            }}
